...
#### Latest Add:
#### Plot: 
Specific type of graph. Plot can contain many path lines crossed with equal value like below 1. Paths can start from same or different source and ends on same or different target. Below simple example {start:[x,y], end:[x,y]} first path (start:[3,Y], end:[3,B]}. Second {start:[0,P], end:[7,X]}. Third {start:[3,Y], end:[7,X]}.
